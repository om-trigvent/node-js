...
/* steps -:
    ...
    -  file uploading
    - check images and avtar upload clodnary
    - createusers objects for cration  & create entry
    - checing response and remove refresh token
    - check user creations with response & error handling
*/
